...
import sys; sys.path.insert(0, os.path.abspath(f"{os.path.dirname(__file__)}/../"))  # isort: skip

from coindcx_src import coindcx_constants as CONSTANTS, coindcx_web_utils as web_utils  # isort: skip
from coindcx_src.coindcx_api_order_book_data_source import CoindcxAPIOrderBookDataSource  # isort: skip
from coindcx_src.coindcx_exchange import CoindcxExchange  # isort: skip
...
class CoinDCXAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    @aioresponses()
    @patch(
        "coindcx_src.coindcx_api_order_book_data_source.CoindcxAPIOrderBookDataSource._time"
    )
    ...
    @patch("coindcx_src.coindcx_api_order_book_data_source.CoindcxAPIOrderBookDataSource"
