...
from coindcx_src import coindcx_constants as CONSTANTS  # isort: skip
from coindcx_src.coindcx_api_user_stream_data_source import CoindcxAPIUserStreamDataSource  # isort: skip
from coindcx_src.coindcx_auth import CoindcxAuth  # isort: skip
...
class CoindcxUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    @patch("coindcx_src.coindcx_api_user_stream_data_source.CoindcxAPIUserStreamDataSource"
