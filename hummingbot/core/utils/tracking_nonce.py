...
class NonceCreator:
    ...
    def get_tracking_nonce(self, ts_us: Optional[Union[float, int]] = None) -> int:
        ...
        :params ts_us: The timestamp to use as the base for the nonce. If not provided the current time will be used.

        :return: the generated nonce
        """
        nonce_candidate = int((ts_us or self._time()) * self._precision)
