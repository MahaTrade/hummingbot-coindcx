            ...
            "data": [
                {
                    ...
                    "order_type": "0",
                    "last_fill_time": "1609926039226",
                    "last_fill_price": str(self.expected_partial_fill_price),
                    "last_fill_count": str(self.expected_partial_fill_amount),
                    "exec_type": "M",
                    "detail_id": self.expected_fill_trade_id,
                    "client_order_id": order.client_order_id
                }
    ...
    def _order_status_request_partially_filled_mock_response(self, order: InFlightOrder) -> Any:
        ...
        return {
            ...
            "data": {
                ...
                "size": str(order.amount),
                "notional": str(order.amount * order.price),
                "filled_notional": str(self.expected_partial_fill_amount * self.expected_partial_fill_price),
                "filled_size": str(self.expected_partial_fill_amount),
